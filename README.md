...
The details of the algorithm can be found in **[Hattori and Komiyama, _Neuron_, 2022]**
...
- Hattori, R. and Komiyama, T. (2022). Context-dependent persistency as a coding mechanism for robust and widely distributed value coding. _Neuron_, 110(3), 502–515..
